...
try: driver.find_element(*LOGOUT_BUTTON).is_displayed() and print("Успешная Авторизаци")
except: driver.find_element(*LOGIN_BUTTON).is_displayed() and print("Пользователь не авторизован")
